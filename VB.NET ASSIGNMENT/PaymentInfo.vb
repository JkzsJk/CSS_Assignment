...
Public Class PInfo
    Dim ConString As String = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=" & Application.StartupPath & "\MemberData\Membership.accdb"
    Dim con As New OleDbConnection(ConString)
    Dim da As New OleDbDataAdapter
    Dim ds, ds1 As New DataSet
    Dim cmd As New OleDb.OleDbCommand
    Dim Sql, Sql1 As String
    Dim curRec, totalRec, totalRec1 As Integer
    ...
    Private Sub add_btn_Click(sender As Object, e As EventArgs) Handles add_btn.Click
        ...
        ds1.Clear()
        Sql1 = "Select * from Payment Order by PaymentID"
        da = New OleDbDataAdapter(Sql1, con)
        da.Fill(ds1, "PaymentID")
        totalRec1 = ds1.Tables("PaymentID").Rows.Count
        paymentID_txt.Text = (ds1.Tables("PaymentID").Rows(totalRec1 - 1).Item(0)) + 1
    ...
    Private Sub amountPaid_txt_TextChanged(sender As Object, e As EventArgs) Handles amountPaid_txt.TextChanged
