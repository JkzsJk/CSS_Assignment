...
Partial Class PaymentReport
    ...
    Private Sub InitializeComponent()
        ...
        Me.DataSet = New CSS_ASSIGNMENT.DataSet()
        Me.PaymentTableAdapter = New CSS_ASSIGNMENT.DataSetTableAdapters.PaymentTableAdapter()
    ...
    Friend WithEvents DataSet As CSS_ASSIGNMENT.DataSet
    Friend WithEvents PaymentTableAdapter As CSS_ASSIGNMENT.DataSetTableAdapters.PaymentTableAdapter
